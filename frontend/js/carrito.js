...
function displayCart() {
    ...
    if (cart.length === 0) {
        cartList.innerHTML = '<p class="empty-cart">Tu carrito está vacío. <a href="shop.html">Continúa comprando</a></p>';
    ...
    // Calcular totales
    const subtotalValue = cart.reduce((sum, item) => sum + (item.precio * (item.quantity || 1)), 0);
